...
namespace LinkedListEx
{
    class BinarySearchTree<T>
    {
        ...
        public T FindMin()
        {
            return DataAt(FindMin(this.Root));
        }

        public T FindMax()
        {
            return DataAt(FindMax(this.Root));
        }

        public T Find(T x)
        {
            return DataAt(Find(x, this.Root));
        }
        ...
        private T DataAt(TreeNode<T> t)
        {
            return t == null ? default(T) : t.Data;
        }
